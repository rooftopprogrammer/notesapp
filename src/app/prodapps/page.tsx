                        ...
                        <div className="space-y-2">
                          {app.links.map((link, linkIndex) => (
                            <div key={linkIndex} className="flex items-start gap-2">
                              <span className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-0.5 flex-shrink-0">
                                {linkIndex + 1}.
                              </span>
                              <a
                                ...
                                className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm break-all hover:underline leading-relaxed"
                              >
                                {link}
                              </a>
                            </div>
                    ...
                    <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="space-y-2">
                          {app.links.map((link, linkIndex) => (
                            <div key={linkIndex} className="flex items-start gap-2">
                              <span className="text-gray-500 dark:text-gray-400 font-medium text-xs mt-0.5 flex-shrink-0">
                                {linkIndex + 1}.
                              </span>
                              <a
                                href={link.startsWith('http') ? link : `https://${link}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 break-all hover:underline leading-relaxed"
                              >
                                {link}
                              </a>
                            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-500 dark:text-gray-400 hover:border-blue-400 hover:text-blue-600 transition-colors flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                      </svg>
