...
const CATEGORY_INFO = {
  ...
  description: 'Track your nutrition, calories, meals, and dietary habits'
};
...
export default function FoodTracker() {
  ...
  useEffect(() => {
    ...
    const foodQuery = query(entriesCollection, where('category', '==', 'food'));
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your food tracker...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/10 dark:to-orange-800/10 border-b border-orange-200 dark:border-orange-800">
        ...
        {entries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start tracking your nutrition and dietary habits by adding your first food entry.
            </p>
            <button
              onClick={handleAdd}
              className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-md transition-colors"
            >
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                Your Food Entries ({entries.length})
              </h3>
            </div>
                ...
                >
                  ...
                  {entry.value && (
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                      Amount: <span className="font-medium">{entry.value}</span>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                  {editingEntry ? 'Edit Food Entry' : 'Add New Food Entry'}
                </h2>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Breakfast, Water intake, Chicken salad..."
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-100"
                    placeholder="Ingredients, preparation method, nutritional notes..."
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-100"
                      placeholder="e.g., calories, glasses, servings..."
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-4 py-2 bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 disabled:cursor-not-allowed text-white rounded-md transition-colors flex items-center justify-center gap-2"
                  >
                    {saving && (
