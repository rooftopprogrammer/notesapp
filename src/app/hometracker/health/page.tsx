...
const CATEGORY_INFO = {
  ...
  description: 'Track your health measurements, doctor visits, and medical checkups'
};
...
export default function HealthTracker() {
  ...
  // Load health entries from Firestore
  useEffect(() => {
    const entriesCollection = collection(db, 'homeTracker');
    const healthQuery = query(entriesCollection, where('category', '==', 'health'));
    
    const unsubscribe = onSnapshot(healthQuery, (snapshot) => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your health tracker...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/10 dark:to-green-800/10 border-b border-green-200 dark:border-green-800">
        ...
        {entries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start tracking your health by adding your first measurement or checkup.
            </p>
            <button
              onClick={handleAdd}
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                Your Health Entries ({entries.length})
              </h3>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Blood pressure check, Doctor visit, Symptoms..."
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:text-gray-100"
                    placeholder="Details about your health measurement or appointment..."
                  />
                </div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-green-400 disabled:cursor-not-allowed text-white rounded-md transition-colors flex items-center justify-center gap-2"
                  >
                    {saving && (
