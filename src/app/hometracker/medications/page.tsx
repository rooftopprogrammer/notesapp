...
const CATEGORY_INFO = {
  ...
  description: 'Track your medications, supplements, and dosages'
};
...
export default function MedicationsTracker() {
  ...
  // Load medications entries from Firestore
  useEffect(() => {
    const entriesCollection = collection(db, 'homeTracker');
    const medicationsQuery = query(entriesCollection, where('category', '==', 'medications'));
    ...
    const unsubscribe = onSnapshot(medicationsQuery, (snapshot) => {
      ...
      console.error('Error fetching medications entries:', error);
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your medications tracker...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/10 dark:to-blue-800/10 border-b border-blue-200 dark:border-blue-800">
        ...
        {entries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start tracking your medications and supplements by adding your first entry.
            </p>
            <button
              onClick={handleAdd}
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md transition-colors"
            >
              Add Your First Medication Entry
            </button>
          </div>
        ) : (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                Your Medication Entries ({entries.length})
              </h3>
            </div>
                ...
                >
                  ...
                  {entry.value && (
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                      Dosage: <span className="font-medium">{entry.value}</span>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                  {editingEntry ? 'Edit Medication Entry' : 'Add New Medication Entry'}
                </h2>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Vitamin D, Ibuprofen, Multivitamin..."
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100"
                    placeholder="Purpose, side effects, instructions, etc..."
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100"
                      placeholder="e.g., tablets, mg, drops..."
                    />
                  </div>
                </div>
