...
const CATEGORY_INFO = {
  ...
  description: 'Track your fitness activities, workouts, and physical measurements'
};
...
export default function FitnessTracker() {
  ...
  // Load fitness entries from Firestore
  useEffect(() => {
    const entriesCollection = collection(db, 'homeTracker');
    const fitnessQuery = query(entriesCollection, where('category', '==', 'fitness'));
    
    const unsubscribe = onSnapshot(fitnessQuery, (snapshot) => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your fitness tracker...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/10 dark:to-red-800/10 border-b border-red-200 dark:border-red-800">
        ...
        {entries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start tracking your fitness journey by adding your first workout or activity.
            </p>
            <button
              onClick={handleAdd}
              className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-md transition-colors"
            >
              Add Your First Fitness Entry
            </button>
          </div>
        ) : (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                Your Fitness Entries ({entries.length})
              </h3>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                  {editingEntry ? 'Edit Fitness Entry' : 'Add New Fitness Entry'}
                </h2>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Morning run, Weight training, Push-ups..."
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:bg-gray-700 dark:text-gray-100"
                    placeholder="Details about your workout or fitness activity..."
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:bg-gray-700 dark:text-gray-100"
                      placeholder="e.g., km, lbs, steps, reps..."
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 disabled:cursor-not-allowed text-white rounded-md transition-colors flex items-center justify-center gap-2"
                  >
                    {saving && (
