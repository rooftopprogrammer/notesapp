...
const LUNCH_DINNER_RECIPES: Recipe[] = [
  {
    id: 'dal-tadka',
    name: 'Dal Tadka',
  ...
  },
  {
    id: 'chicken-curry',
    name: 'Chicken Curry',
    description: 'Traditional spiced chicken curry with rich gravy',
    cookTime: '45 mins',
    servings: '4',
    difficulty: 'Medium',
  ...
  },
  {
    ...
    description: 'Healthy mixed vegetables in coconut curry',
    cookTime: '25 mins',
    servings: '4',
    difficulty: 'Easy',
    tags: ['Vegetarian', 'Healthy', 'Coconut Based']
  }
];
...
export default function LunchDinnerPage() {
  ...
  const filteredRecipes = LUNCH_DINNER_RECIPES.filter(recipe => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Hearty main course dishes and curries for lunch and dinner
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1">
                {recipe.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="px-2 py-1 bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-400 text-xs rounded-full"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="text-center">
          <button className="inline-flex items-center px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors gap-2 shadow-lg hover:shadow-xl">
            ➕ Add New Recipe
          </button>
        </div>
      </div>
