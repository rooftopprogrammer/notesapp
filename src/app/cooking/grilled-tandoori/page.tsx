    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 dark:text-gray-500 mb-6">Sizzling grilled recipes coming your way!</p>
          <button className="bg-pink-600 hover:bg-pink-700 text-white px-6 py-2 rounded-lg transition-colors">➕ Add Recipe</button>
        </div>
      </div>
    </div>
  );
