...
export default function Business() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!querySnapshot.empty) {
        ...
        // Note: In production, you might want to update lastLogin field
  ...
  if (!isAuthenticated) {
    return (
      <main className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          {/* Back button */}
          <div className="mb-6">
            <Link 
              href="/"
              className="inline-flex items-center p-2 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow"
            >
              <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
              <span className="ml-2 text-gray-600">Back to Home</span>
            </Link>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-800 mb-2">Business Hub Login</h1>
              <p className="text-gray-600">Please sign in to access business features</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-medium py-2 px-4 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
              >
                {isLoading ? (
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              {currentUser && (
                <p className="text-sm text-gray-600 mt-1">Welcome back, {currentUser.username}</p>
              )}
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow text-gray-600 hover:text-gray-800"
          >
